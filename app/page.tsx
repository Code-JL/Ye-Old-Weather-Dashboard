        ...
        <div className="bg-white dark:bg-mono-800 rounded-lg shadow-lg p-8 markdown-content">
          <ReactMarkdown 
            ...
            components={{
              ...
              p: (props) => <p className="text-mono-800 dark:text-mono-100 mb-4 leading-relaxed" {...props} />,
              a: (props) => <a className="text-weather-primary dark:text-weather-primary hover:underline" {...props} />,
              ul: (props) => <ul className="list-disc list-inside mb-4 text-mono-800 dark:text-mono-100" {...props} />,
